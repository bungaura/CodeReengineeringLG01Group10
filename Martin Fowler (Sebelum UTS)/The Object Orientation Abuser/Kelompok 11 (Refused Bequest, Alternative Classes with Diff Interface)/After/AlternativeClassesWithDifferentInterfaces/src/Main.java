...
public class Main {
	...
	public static void main(String[] args) {
        ...
        USDConverter converterEUR = new USDConverter("EUR");
        double totalPriceEUR = converterEUR.convert(totalPriceUSD);
        System.out.println("Total price in EUR: " + String.format("%.2f", totalPriceEUR));

        // Ubah total harga ke IDR
        USDConverter converterIDR = new USDConverter("IDR");
        double totalPriceIDR = converterIDR.convert(totalPriceUSD);
